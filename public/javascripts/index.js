...
obertka = document.createElement("div");
    obertka.innerHTML=`<br><div class="input-group"id="${i}&${temp}leschat">`+
`<div class="input-group-prepend">`+
` <div class="input-group-text" id="${i}&${temp}sosat">`+
`</div></div></div>`;
document.getElementById("tr[" + index + "]").appendChild(obertka);
        ...
        document.getElementById(`${i}&${temp}sosat`).appendChild(rd);
        ...
        document.getElementById(`${i}&${temp}leschat`).appendChild(options);
    }
